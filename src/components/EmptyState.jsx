  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-10 max-w-2xl mx-auto text-center px-4 select-none animate-fade-in">
      ...
      <div className="relative">
        ...
        <div className="w-16 h-16 rounded-2xl bg-indigo-600/10 text-indigo-400 border border-indigo-500/20 flex items-center justify-center mx-auto shadow-xl shadow-indigo-600/10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-xl">
        <div className="p-3.5 rounded-xl bg-zinc-900/30 border border-zinc-800/60 space-y-1.5 text-center">
          <Database className="w-4 h-4 text-indigo-400 mx-auto" />
          <h3 className="text-xs font-semibold text-zinc-200">FAISS Storage</h3>
        ...
        <div className="p-3.5 rounded-xl bg-zinc-900/30 border border-zinc-800/60 space-y-1.5 text-center">
          ...
          <h3 className="text-xs font-semibold text-zinc-200">Contextual RAG</h3>
          <p className="text-[10px] text-zinc-400 leading-normal">
        ...
        <div className="p-3.5 rounded-xl bg-zinc-900/30 border border-zinc-800/60 space-y-1.5 text-center">
          <MessageSquareCode className="w-4 h-4 text-amber-400 mx-auto" />
          <h3 className="text-xs font-semibold text-zinc-200">Citations Cited</h3>
          <p className="text-[10px] text-zinc-400 leading-normal">
