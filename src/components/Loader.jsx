...
export default function Loader() {
  ...
  return (
    <div className="flex gap-4 w-full justify-start animate-fade-in">
      {/* Pulse icon wrapper */}
      <div className="w-8 h-8 rounded-lg bg-indigo-600/10 text-indigo-400 border border-indigo-500/20 flex items-center justify-center flex-shrink-0 animate-pulse relative">
      ...
      <div className="flex-1 space-y-3.5 max-w-[70%]">
        ...
        <div className="space-y-2.5 bg-zinc-900 border border-zinc-800/80 rounded-2xl p-4 w-full">
          <div className="h-3.5 bg-zinc-800 rounded-md w-[95%] animate-pulse relative overflow-hidden">
          ...
          <div className="h-3.5 bg-zinc-800 rounded-md w-[85%] animate-pulse relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-zinc-700/20 to-transparent -translate-x-full animate-[shimmer_1.5s_infinite]" />
          </div>
          <div className="h-3.5 bg-zinc-800 rounded-md w-[50%] animate-pulse relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-zinc-700/20 to-transparent -translate-x-full animate-[shimmer_1.5s_infinite]" />
          </div>
        </div>
      </div>
